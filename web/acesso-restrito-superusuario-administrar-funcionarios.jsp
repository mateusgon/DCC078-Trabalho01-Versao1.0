...
<div class="container text-center">
    <div class="row" style="margin-top: 1.5cm">
        <div class="col-sm-4">
            <div class="card">
                <div class="card-body">
                    <a href="FrontController?action=CadastrarFuncionario&id=${idRest}" >
                        <h5 class="card-title"> Cadastar Funcionários </h5>
        ...
        <div class="col-sm-4" >
            <div class="card">
                <div class="card-body">
                    <a href="FrontController?action=ListarFuncionarios&id=${idRest}">
                        <h5 class="card-title"> Ver Funcionários </h5>
