...
public class EditarRestaurantePostAction implements Action {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        restaurante = restaurante.setNome(nome).setNomeFantasia(nomeFantasia).setTelefone(telefone).setEndereco(endereco).setSigla(sigla).setRestaurantecod(idRestaurante);
